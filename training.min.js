...
nc || (nc = {}), nc.bns || (nc.bns = {}), nc.bns.training || (nc.bns.training = {}),
    function() {
        ...
        nc.bns.training.Model = {}, nc.bns.training.Model.SORT_INPUT_ARR = ["LB", "RB", "F", "TAB", "1", "2", "3", "4", "Z", "X", "C", "V", "Q", "E", "W", "S", "NONE"], nc.bns.training.Model.SORT_INPUT_OBJ = {
            ...
            SM: "Lyn Blade Master",
            WL: "Warlock"
        }, nc.bns.training.Model.SKILL_IMG_URL_FRONT = "../img/skill/", nc.bns.training.Model.NO_TRAINING_DESC = " does not have a skill tree.", nc.bns.training.Model.CATEGORY_MOVE_POSY_PER_MOUSE_WHEEL = 31, nc.bns.training.Model.MIN_LEVEL_CAN_USE_SKILL_POINT = 15, nc.bns.training.Model.MIN_LEVEL_CAN_USE_MASTERY_LEVEL = 45, nc.bns.training.Model.LEVEL_SWITCH_MASTERY_LEVEL_RANGE = 45, nc.bns.training.Model.MASTERY_LEVEL_RANGE_BY_LEVEL_OBJ = {
            45: "5"
        ...
        nc.bns.training.util = {}, nc.bns.training.util.StringUtil = {
            ...
            function init($flag_initializeFirst, $jsonObj) {
                ...
                function getHeaderStr() {
                    var a = '<div class="header"><span class="level select_level">Level <strong>' + nc.bns.training.Model.level + '</strong><span class="btn_level"></span><ul class="ly_level"></ul></span><span class="mastery_level select_level">' + nc.bns.training.Model.masteryTitle + "<strong>" + nc.bns.training.Model.masteryLevel + '</strong><span class="btn_level"></span><ul class="ly_level"><li>0</li></ul></span><span><a href="javaScript:void(0);" class="btn_reset_all" onclick="reset_all()">Reset All</a></span><span><a href="javaScript:void(0);" class="btn_reset" onclick="reset()">Reset Skill</a></span></div>';
                    return a
                }
                ...
                for (var _tmpObj, initialStr, i = 0, max = objArr.length; max > i; i++) {
                    if (_tmpObj = objArr[i], _tmpObj.name2_refine && (initialStr = _tmpObj.name2_refine, _tmpObj.initName2Refine = initialStr, _tmpObj.initJamoStr = nc.bns.training.util.StringUtil.getInitialJamoStr(initialStr, nc.bns.training.Model.SORT_NAME_ARR), _tmpObj.name2_refine = initialStr), _tmpObj.consumedSkillPoint = 0, _tmpObj.learnedSkillVariationId = "", _tmpObj.learnedSkillTooltipAlias = "", _tmpObj.learnedSkillAlias = "", _tmpObj.skillType = "", _tmpObj.disable = "", getFlagNoTrainingSkill(_tmpObj)) _tmpObj.skillType = nc.bns.training.Model.SKILL_TYPE_NONE;
                        ...
                        if (flag_break)
                            if (flag_acquisitionSkill) _tmpObj.skillType = nc.bns.training.Model.SKILL_TYPE_ACQUISITION;
                            else {
            ...
            var j = '<img src="../img/skill_ui_mod.png">',
                k = document.createElement("span");
            $(k).addClass("ui_skill_add");
            var l = '<img src="../img/skill_ui_add.png" />',
            ...
            function i(a) {
                nc.bns.training.Model.editable && (s.css("cursor", "auto"), s.unbind("mouseover", j), s.unbind("mouseout", j), s.unbind("mousedown", j), s.unbind("click", j), s.unbind("contextmenu", j), a && (s.css("cursor", "pointer"), s.bind("mouseover", j), s.bind("mouseout", j), s.bind("mousedown", j), s.bind("click", j), s.bind("contextmenu", j)))
            }
